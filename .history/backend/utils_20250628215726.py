...
def verify_md5_signature(params: Dict[str, Any], key: str, sign: str) -> bool:
    """
    验证 ZPay 异步通知的 MD5 签名
    
    Args:
        params: 通知参数字典（包含所有GET参数）
        key: 商户密钥
        sign: 传入的签名字符串
