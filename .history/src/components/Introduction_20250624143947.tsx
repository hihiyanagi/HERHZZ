  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 relative">
      ...
      <div className="flex flex-col items-center mb-6 z-10">
        <h2 className={cn(
          "text-4xl md:text-6xl font-fancy moon-glow tracking-wider animate-title",
      ...
      <h3 className={cn(
        "text-4xl md:text-6xl font-biaoxiao moon-glow mb-12 z-10 text-center animate-float tracking-wide",
