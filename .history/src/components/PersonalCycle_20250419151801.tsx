      ...
      {!hasSubmitted ? (
        ...
        <div className="max-w-2xl mx-auto animate-fade-in">
          <button 
            ...
            className="mb-6 flex items-center text-moon-dark hover:text-moon-DEFAULT transition-colors"
          >
          ...
          {currentPhase && (
            <>
              <h2 className="text-2xl md:text-3xl font-bold text-night-dark text-center mb-4">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 mb-6 shadow-sm">
                <h3 className="text-xl font-semibold text-moon-dark mb-4">推荐白噪音</h3>
                ...
                <h3 className="text-xl font-semibold text-moon-dark mb-4">导入语</h3>
                <div className="bg-moon-soft/30 p-4 rounded-lg">
