  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 bg-gradient-to-b from-night-light to-moon-soft">
      <div className="flex flex-col items-center mb-6">
        <h2 className="text-5xl font-bold text-moon-dark tracking-wider animate-title font-playwrite">
          HERHZZZ
        </h2>
      </div>
      ...
      <div ref={textRef} className="max-w-2xl text-night-dark mb-10">
        <div className="fade-in-section space-y-8 p-8 rounded-lg bg-white/50 backdrop-blur-sm leading-loose">
