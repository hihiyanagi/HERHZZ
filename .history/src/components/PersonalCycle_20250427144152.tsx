...
const PersonalCycle = ({ onReset }: PersonalCycleProps) => {
  ...
  return (
    <div 
      className="min-h-screen p-6 bg-gradient-to-b from-moon-DEFAULT via-moon-dark to-starry-DEFAULT"
      style={{
        backgroundImage: !hasSubmitted 
          ? "linear-gradient(to bottom, var(--tw-gradient-stops))" 
          : "url('/images/starry-background.svg')",
