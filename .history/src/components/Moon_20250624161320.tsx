...
const Moon: React.FC<MoonProps> = ({ size = 200, moonColorScheme = "cool" }) => {
  ...
  return (
    ...
    >
      ...
      {isMobile && (
        <div 
          className={`absolute rounded-full bg-gradient-to-r ${glowColors.from} ${glowColors.to} animate-pulse`}
          style={{
            width: `${size * 1.1}px`,
            height: `${size * 1.1}px`,
            opacity: 0.3,
      ...
      <div 
        ...
        style={{
          ...
          boxShadow: isMobile 
            ? '0 0 20px rgba(255, 245, 160, 0.15)' // 移动端简化阴影
