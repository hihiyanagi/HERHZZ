        ...
        <div className="fade-in-section p-4 md:p-8 rounded-lg backdrop-blur-sm leading-loose bg-white/5">
          ...
          <div className="block md:hidden space-y-8">
            <div className="space-y-1">
              <p className="text-xs">有些夜晚，我们会突然失眠，</p>
              <p className="text-xs">翻来覆去找不到原因。</p>
              <p className="text-xs">但其实，我们的身体并没有出错，</p>
              <p className="text-xs">它只是像月亮一样，</p>
              <p className="text-xs">在进行一场悄无声息的变化。</p>
            </div>

            <div className="space-y-1">
              <p className="text-xs">月经的潮汐、情绪的涨落、睡眠的深浅，</p>
              <p className="text-xs">都是我们身体与自然之间的共鸣。</p>
              <p className="text-xs">所以，当你发现自己睡不着，不必焦虑或责备。</p>
              <p className="text-xs">你正在经历的，只是你自己的"月亮"时刻。</p>
            </div>

            <div className="space-y-1">
              <p className="text-xs">你不是孤单的。</p>
              <p className="text-xs">月亮在我们的身体里，我们必定好梦。</p>
              <p className="text-xs">这是一款专为女性周期设计的白噪音工具，</p>
              <p className="text-xs">跟随你的周期，回应你的波动，</p>
              <p className="text-xs">用声音伴你入梦。</p>
            </div>
          </div>
