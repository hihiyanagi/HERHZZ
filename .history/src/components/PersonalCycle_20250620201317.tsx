...
const determineCyclePhase = (
  ...
  const currentCycleDay = (daysSinceStart % 28) + 1; // 1-28天循环
  
  if (currentCycleDay < settings.menstrualDays) return "menstrual";
  if (currentCycleDay < settings.cycleLength * 0.4) return "follicular"; 
  if (currentCycleDay < settings.cycleLength * 0.6) return "ovulation";
  return "luteal";
};
