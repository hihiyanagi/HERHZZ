...
const Introduction = ({ onContinue }: IntroductionProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6">
      ...
      <div ref={textRef} className="max-w-2xl text-white mb-10">
      ...
      {onContinue && (
        <button 
          onClick={onContinue}
          className="px-8 py-3 bg-transparent hover:bg-white/20 border border-white text-white rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
        >
          继续
        </button>
      )}
