      ...
      <div 
        ...
        style={{
          ...
          background: moonColorScheme === "warm" 
            ? `radial-gradient(circle, rgba(254, 250, 113, 0.25) 0%, rgba(255, 229, 102, 0.15) 40%, transparent 70%)`
            : `radial-gradient(circle, rgba(140, 125, 177, 0.15) 0%, rgba(163, 149, 201, 0.1) 40%, transparent 70%)`,
          outline: 'none',
          border: 'none',
          WebkitTapHighlightColor: 'transparent',
