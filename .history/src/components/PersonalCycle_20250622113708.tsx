      ...
      <div className={`relative z-10 ${!hasSubmitted ? 'pt-8' : ''}`}>
        {!hasSubmitted ? (
          <div className="max-w-md mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-8 animate-pulse hover:animate-bounce transition-all duration-500 tracking-wide">
              输入你的周期
            </h2>
          ...
          <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            {currentPhase && (
              <>
                <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-6 animate-pulse hover:animate-bounce transition-all duration-500 tracking-wide">
