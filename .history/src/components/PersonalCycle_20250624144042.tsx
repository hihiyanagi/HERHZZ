      ...
      <div className={`relative z-10 ${!hasSubmitted ? 'pt-8' : ''}`}>
        {!hasSubmitted ? (
          <div className="max-w-md mx-auto">
            <h2 className={cn(
              "text-4xl md:text-6xl font-biaoxiao moon-glow text-center mb-8 animate-float tracking-wide",
...
VITE_SUPABASE_ANON_KEY=你的匿名密钥
          ...
          <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            {currentPhase && (
              <>
                <h2 className={cn(
                  "text-4xl md:text-6xl font-biaoxiao moon-glow text-center mb-6 animate-float tracking-wide",
                  "transition-all duration-500 ease-out transform",
                  fontsLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                )}>
