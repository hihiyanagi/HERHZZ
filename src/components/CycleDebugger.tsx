    ...
    <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg max-w-4xl mx-auto mt-8">
      ...
      <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
        ...
        <div className="text-yellow-100 text-sm space-y-1">
          <p>1. 首先运行"快速连接测试"确保基础配置正确</p>
          <p>2. 确保你已经登录并且Supabase配置正确</p>
          <p>3. 如果没有周期数据，请使用"输入周期"功能添加数据</p>
          <p>4. 如果数据库测试失败，请检查环境变量配置</p>
          <p>5. 数据应该会自动同步到Supabase的menstrual_cycles表</p>
        </div>
      </div>
    </div>
  );
